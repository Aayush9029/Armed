...
extension NSSound {
    ...
    public static var systemVolume: Float {
        get { return getSystemVolume() }
        set { setSystemVolume(theVolume: newValue) }
    }
    ...
    public static var systemVolumeIsMuted: Bool {
        get { return getSystemVolumeIsMuted() }
        set { systemVolumeSetMuted(newValue) }
    }
    ...
    public class func systemVolumeFadeToMute(seconds: Float = 3, blocking: Bool = true) {
        ...
        if blocking { fadeSystemVolumeToMutePrivate(seconds: seconds) } else { DispatchQueue.global().async { self.fadeSystemVolumeToMutePrivate(seconds: seconds) } }
    }
    ...
    private class func obtainDefaultOutputDevice() -> AudioDeviceID {
        ...
        theAddress = AudioObjectPropertyAddress(mSelector: kAudioHardwarePropertyDefaultOutputDevice, mScope: kAudioObjectPropertyScopeGlobal, mElement: kAudioObjectPropertyElementMain)
    ...
    private class func getSystemVolume() -> Float {
        ...
        theAddress = AudioObjectPropertyAddress(mSelector: kAudioHardwareServiceDeviceProperty_VirtualMainVolume, mScope: kAudioDevicePropertyScopeOutput, mElement: kAudioObjectPropertyElementMain)
    ...
    private class func setSystemVolume(theVolume: Float, muteOff: Bool = true) {
        ...
        theAddress = AudioObjectPropertyAddress(mSelector: kAudioDevicePropertyMute, mScope: kAudioDevicePropertyScopeOutput, mElement: kAudioObjectPropertyElementMain)
    ...
    private class func fadeSystemVolumeToMutePrivate(seconds: Float) {
        ...
        let currentVolume = systemVolume
